...
reorder_files -fileset constrs_1 -front [get_files adrv9361-z7035_board_base_constr.tcl]
...
set_property CONFIG.PCW_PACKAGE_NAME {fbg676} [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_GPIO_MIO_GPIO_ENABLE 1 [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_ENET0_PERIPHERAL_ENABLE 1 [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_ENET0_ENET0_IO {MIO 16 .. 27} [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_ENET0_GRP_MDIO_ENABLE 1 [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_ENET0_GRP_MDIO_IO {MIO 52 .. 53} [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_ENET1_PERIPHERAL_ENABLE 1 [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_ENET_RESET_SELECT {Separate reset pins} [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_ENET0_RESET_ENABLE 1 [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_ENET0_RESET_IO {MIO 8} [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_ENET1_RESET_ENABLE 1 [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_ENET1_RESET_IO {MIO 51} [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_SD0_PERIPHERAL_ENABLE 1 [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_SD0_GRP_CD_ENABLE 1 [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_SD0_GRP_CD_IO {MIO 50} [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_SDIO_PERIPHERAL_FREQMHZ 50 [get_bd_cells ps_sys_7]
...
set_property CONFIG.PCW_USB0_RESET_IO {MIO 7} [get_bd_cells ps_sys_7]
...
set_property CONFIG.PCW_UIPARAM_DDR_BUS_WIDTH {32 Bit} [get_bd_cells ps_sys_7]
...
set_property CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_0 -0.053 [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_1 -0.059 [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_2 0.065 [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_3 0.066 [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY0 0.264 [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY1 0.265 [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY2 0.330 [get_bd_cells ps_sys_7]
set_property CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY3 0.330 [get_bd_cells ps_sys_7]
