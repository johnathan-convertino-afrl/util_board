...
set_property  -dict {PACKAGE_PIN  Y17   IOSTANDARD LVCMOS25} [get_ports gpio_bd[13]]                  ; ## U1,Y17,IO_L19_12_JX2_P,JX2,88,SFP_GPIO_0
set_property  -dict {PACKAGE_PIN  AA17  IOSTANDARD LVCMOS25} [get_ports gpio_bd[14]]                  ; ## U1,AA17,IO_L19_12_JX2_N,JX2,90,SFP_GPIO_1
set_property  -dict {PACKAGE_PIN  AB17  IOSTANDARD LVCMOS25} [get_ports gpio_bd[15]]                  ; ## U1,AB17,IO_L20_12_JX2_P,JX2,87,SFP_GPIO_2
set_property  -dict {PACKAGE_PIN  AB16  IOSTANDARD LVCMOS25} [get_ports gpio_bd[16]]                  ; ## U1,AB16,IO_L20_12_JX2_N,JX2,89,SFP_GPIO_3
set_property  -dict {PACKAGE_PIN  AC17  IOSTANDARD LVCMOS25} [get_ports gpio_bd[17]]                  ; ## U1,AC17,IO_L21_12_JX2_P,JX2,93,SFP_GPIO_4
set_property  -dict {PACKAGE_PIN  AC16  IOSTANDARD LVCMOS25} [get_ports gpio_bd[18]]                  ; ## U1,AC16,IO_L21_12_JX2_N,JX2,95,SFP_GPIO_5
set_property  -dict {PACKAGE_PIN  AA15  IOSTANDARD LVCMOS25} [get_ports gpio_bd[19]]                  ; ## U1,AA15,IO_L22_12_JX2_P,JX2,94,SFP_GPIO_6
...
# spi pmod up/down converter

set_property  -dict {PACKAGE_PIN  AC18  IOSTANDARD LVCMOS25  PULLTYPE PULLUP} [get_ports spi_udc_csn_tx]  ; ## U1,AC18,IO_L21_13_JX2_P,JX2,67,PMOD0_D0,R95,1
set_property  -dict {PACKAGE_PIN  W18   IOSTANDARD LVCMOS25  PULLTYPE PULLUP} [get_ports spi_udc_csn_rx]  ; ## U1,W18,IO_L23_13_JX2_P,JX2,73,PMOD0_D4,R97,1
set_property  -dict {PACKAGE_PIN  AB19  IOSTANDARD LVCMOS25}                  [get_ports spi_udc_sclk]    ; ## U1,AB19,IO_L22_13_JX2_N,JX2,70,PMOD0_D3,R104,1
set_property  -dict {PACKAGE_PIN  AC19  IOSTANDARD LVCMOS25}                  [get_ports spi_udc_data]    ; ## U1,AC19,IO_L21_13_JX2_N,JX2,69,PMOD0_D1,R103,1
set_property  -dict {PACKAGE_PIN  AA19  IOSTANDARD LVCMOS25}                  [get_ports gpio_muxout_tx]  ; ## U1,AA19,IO_L22_13_JX2_P,JX2,68,PMOD0_D2,R96,1
set_property  -dict {PACKAGE_PIN  Y18   IOSTANDARD LVCMOS25}                  [get_ports gpio_muxout_rx]  ; ## U1,Y18,IO_L24_13_JX2_P,JX2,74,PMOD0_D6,R98,1
