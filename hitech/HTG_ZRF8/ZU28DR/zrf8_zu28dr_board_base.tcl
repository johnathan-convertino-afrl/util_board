...
reorder_files -fileset constrs_1 -front [get_files zrf8_zu28dr_board_base_constr.tcl]
...
\
    ...
    CONFIG.PSU__CRF_APB__ACPU_CTRL__FREQMHZ {1200.00} \
    ...
    CONFIG.PSU__CRL_APB__CPU_R5_CTRL__FREQMHZ {500.00} \
